export const translations = {
  pt: {
    ...
    hero: {
      ...
      desc: 'Sou um desenvolvedor Full Stack especializado em unir o rigor técnico do backend com a fluidez de interfaces de altíssima fidelidade. Crio soluções escaláveis que transformam ideias em produtos digitais de impacto.',
      ...
      items: [
        {
          ...
          tag: 'Full-Stack',
          desc: 'Desenvolvimento completo de plataformas SaaS — do banco de dados ao deploy. Arquitetura robusta, autenticação, dashboard e UI premium.',
          highlights: ['Next.js + TypeScript', 'PostgreSQL / Supabase', 'Deploy na Vercel / Coolify', 'UI/UX de alta fidelidade'],
        },
        {
          icon: '🤖',
          title: 'Automações & IA',
          tag: 'IA / Automação',
          desc: 'Agentes de IA para WhatsApp, Instagram e sistemas internos. Integração com CRMs, qualificação de leads e atendimento 24/7.',
          highlights: ['Gemini / GPT integrado', 'WhatsApp & Instagram API', 'Fluxos com N8N', 'Redução de 80% no suporte'],
        },
        {
          icon: '⚡',
          title: 'APIs & Integrações',
          tag: 'Backend',
          desc: 'APIs REST escaláveis, seguras e bem documentadas. Integração entre sistemas, gateways de pagamento e microsserviços.',
          highlights: ['Node.js / Python / Java', 'REST APIs documentadas', 'Integrações de pagamento', 'Alta performance'],
        },
      ],
    },
    testimonials: {
    ...
    chat: {
      ...
      welcome: 'Olá! Sou a IA do Carlos, alimentada pelo Gemini. Posso responder sobre seus projetos, habilidades, experiência ou orçamentos. Como posso ajudar?',
      ...
      replyDefault: 'Olá! Sou o assistente de portfólio do Carlos. Posso te contar sobre projetos, habilidades, experiência ou orçamentos. O que você gostaria de saber?',
    }
  },
  en: {
    nav: {
    ...
    hero: {
      ...
      desc: 'I am a Full Stack developer specialized in combining backend technical rigor with the fluidity of ultra high-fidelity interfaces. I build scalable solutions that transform ideas into impactful digital products.',
      ...
      items: [
        {
          ...
          tag: 'Full-Stack',
          desc: 'Complete SaaS platform development — from database to deploy. Robust architecture, authentication, dashboard and premium UI.',
          highlights: ['Next.js + TypeScript', 'PostgreSQL / Supabase', 'Vercel / Coolify deploy', 'High-fidelity UI/UX'],
        },
        {
          icon: '🤖',
          title: 'Automations & AI',
          tag: 'AI / Automation',
          desc: 'AI agents for WhatsApp, Instagram and internal systems. CRM integration, lead qualification and 24/7 support.',
          highlights: ['Gemini / GPT integrated', 'WhatsApp & Instagram API', 'N8N Workflows', '80% support reduction'],
        },
        {
          icon: '⚡',
          title: 'APIs & Integrations',
          tag: 'Backend',
          desc: 'Scalable, secure and well-documented REST APIs. System integrations, payment gateways and microservices.',
          highlights: ['Node.js / Python / Java', 'Documented REST APIs', 'Payment integrations', 'High performance'],
        },
      ],
    },
    testimonials: {
    ...
    chat: {
      ...
      welcome: "Hi! I'm Carlos's AI, powered by Gemini. I can answer about his projects, skills, experience or quotes. How can I help?",
      placeholder: 'Ask about projects, skills, quotes...',
      btnProjects: 'View Projects',
      btnQuote: 'Get a Quote',
      btnSkills: 'View Skills',
      btnWhatsApp: 'Direct WhatsApp',
      replyDefault: "Hi! I'm Carlos's portfolio assistant. I can tell you about projects, skills, experience or quotes. What would you like to know?",
    }
  }
} as const;
